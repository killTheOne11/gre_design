...
{
    /// <summary>
    /// The C# implementation of the contract defined in first_test_contract.proto that is located in the "protobuf"
    /// folder.
    /// Notice that it inherits from the protobuf generated code. 
    /// </summary>
    public class FirstTestContract : FirstTestContractContainer.FirstTestContractBase
    {
        /// <summary>
